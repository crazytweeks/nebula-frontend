            ...
            <Dropdown>
              <DropdownTrigger>
                <Button isIconOnly size="sm" variant="light">
                  <IconVerticalDots className="text-default-300" />
                </Button>
              </DropdownTrigger>
              <DropdownMenu>
          ...
          <div className="flex gap-3">
            <Dropdown>
              ...
              <DropdownMenu
                ...
                onSelectionChange={(value) => setStatusFilter(value.toString())} //TODO: Recheck if working
              >
            ...
            <Dropdown>
              ...
              <DropdownMenu
                ...
                onSelectionChange={(value) =>
                  setVisibleColumns(value as unknown as string[])
